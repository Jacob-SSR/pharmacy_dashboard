...
export function demoQueue(date: string): QueueRow[] {
  ...
  return SEEDS.map((s, i) => {
    ...
    return {
      ...
      waitMin: s.agoMin,
      pttype: s.pttype,
      referringDeptCode: s.stage === "dispensed" ? "051" : ["001", "002", "003", ""][i % 4],
      referringDept: s.stage === "dispensed" ? "ห้องยาผู้ป่วยนอก" : ["ห้องตรวจอายุรกรรม", "ห้องตรวจศัลยกรรม", "ห้องฉุกเฉิน", ""][i % 4],
      curDeptCode: "051",
